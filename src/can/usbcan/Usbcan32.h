...
#define USBCAN_PRODCODE_MASK_PID            0x0000FFFFL
...
#define USBCAN_CYCLIC_FLAG_SEQUMODE         0x40000000L     // list of cyclcic CAN messages will be processed sín
...
#define kVerTypeUserDll         0x00000001L // returns the version of USBCAN32.DLL
#define kVerTypeSysDrv          0x00000002L // returns the version of USBCAN.SYS
#define kVerTypeFirmware        0x00000003L // returns the version of firmware in hardware (not supported, use function UcanGetFwVersion)
#define kVerTypeNetDrv          0x00000004L // returns the version of UCANNET.SYS (not supported in this version)
#define kVerTypeSysLd           0x00000005L // returns the version of USBCANLD.SYS
#define kVerTypeSysL2           0x00000006L // returns the version of USBCANL2.SYS
#define kVerTypeSysL3           0x00000007L // returns the version of USBCANL3.SYS
#define kVerTypeSysL4           0x00000008L // returns the version of USBCANL4.SYS
#define kVerTypeSysL5           0x00000009L // returns the version of USBCANL5.SYS
#define kVerTypeCpl             0x0000000AL // returns the version of USBCANCP.CPL
