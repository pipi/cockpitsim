...
\item un autre codait la partie CAN du module USB/CAN,
\item un autre codait la partie CAN sur le BECK.
\end{itemize}

La réalisation s'est déroulée rapidement. La décomposition en sous-ensembles indépendants a permis de minimiser
l'apparition d'erreurs dans la suite du développement du projet.
