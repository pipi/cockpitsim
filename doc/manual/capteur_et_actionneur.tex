...
Comme un appui sur une touche dure environ 100 ms, nous avons choisi un TIMER de 50 ms ce qui est raisonnable, tou
appui peut être détecté dans le temps impartit.
