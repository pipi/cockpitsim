...
La programmation du GALisp22v10, a était faite via Abel, cf.ANNEXE Abel GAL, afin de réaliser la fonction half_duplex, expliquée dans la partie précèdente.
...
Pour l'alimentation de la carte, nous avons utilisé un régulateur 7805T, capable de fournir une tension de 5v (output) en sortie afin d'alimenter le GAL et le MAX233 et d'avoir une tension de l'ordre de 9.6v (input) pour l'alimentation des AX12 \ref{fig:7805}:
