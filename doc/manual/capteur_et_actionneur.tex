...
Dans un premier temps, nous avons envisagé que le FPGA traite les informations lui-même en en mettant en place le protocole de détection de touche. Une requête de lecture du clavier étant détectée, le FPGA renvoie la valeur associée de la dernière touche appuyée (de 1 à 72). Si cette valeur a déjà été envoyée et que l'un détecte une nouvelle requête de lecture de la part du beck, le FPGA renvoie la valeur 0.
