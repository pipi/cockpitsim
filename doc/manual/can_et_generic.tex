...
Tout d'abord, afin de pouvoir utiliser le bus CAN et le bus I$^2$C, nous avons utiliser la blibliothèque que l'on a créé can-i2c.h.
...
\item l'identifiant I$^2$C de l'esclave qui est concerné par les message CAN dontlidentifiant est le même que ci-dessus,
