...
Comme nous l'avons précisé précédemment, l'objectif de cette partie est de relier Flight Simulator X à notre simulateur. Plus précisément, nous voulions créer une variable pour chaque boutons du cockpit (par exemple, une variable pour un switch), celle-ci sera relié aux données disponible sur FSadapter par l'intermédiaire du logiciel. Une fois toutes les variables créer, il fallait définir les trames à envoyer à travers le bus CAN. L'idée est de déterminer précisément .
