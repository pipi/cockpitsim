...
Lors de l'étude initiale de cette partie du projet, il a été fait le choix de l'écrire
en C++ dû au fait qu'FSUIPC est fortement polymorphe \footnote{FSUIPC contient des données
...
sont à 0. Dans le sens inverse, des modules CAN vers FSAdapter, les trois derniers bits permettent de déterminer quel paramètre de la trame qui correspond à la donnée a été modifié. Les autres bits de l'identifiant permettent de différencier les familles entre
elles.
...
solution initiale en C++. Une fois le développement abouti, nous avons pu faire fonctionner notre logiciel comme interface avec 
